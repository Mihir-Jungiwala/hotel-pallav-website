...
$richFields = ['hero_lead', 'about_p1', 'about_p2', 'about_p3', 'enquire_lead', 'footer_tagline'];
$clean = [];
...
db_run(
    'UPDATE page_content SET hero_title_line1=?, hero_title_emphasis=?, hero_lead=?, quick_check_title=?, qc_msg_pick_dates=?, qc_msg_available=?, qc_msg_unavailable=?, qc_msg_error=?, fm_msg_name=?, fm_msg_phone=?, fm_msg_email=?, fm_msg_checkin=?, fm_msg_checkout=?, fm_msg_room=?, fm_msg_adults=?, fm_msg_children=?, fm_msg_message=?, about_kicker=?, about_heading=?, about_p1=?, about_p2=?, about_p3=?, enquire_heading=?, enquire_lead=?, enquire_points=?, footer_tagline=? WHERE id=?',
    [
