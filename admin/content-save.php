...
db_run(
    'UPDATE page_content SET hero_eyebrow=?, hero_title_line1=?, hero_title_emphasis=?, hero_lead=?, about_kicker=?, about_heading=?, about_p1=?, about_p2=?, about_p3=?, enquire_heading=?, enquire_lead=?, enquire_points=?, footer_tagline=?, footer_credit=? WHERE id=?',
    [
