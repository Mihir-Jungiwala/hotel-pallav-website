...
db_run(
    'UPDATE page_content SET hero_title_line1=?, hero_title_emphasis=?, hero_lead=?, quick_check_title=?, qc_msg_pick_dates=?, qc_msg_available=?, qc_msg_unavailable=?, qc_msg_error=?, fm_msg_name=?, fm_msg_phone=?, fm_msg_email=?, fm_msg_checkin=?, fm_msg_checkout=?, fm_msg_room=?, fm_msg_adults=?, fm_msg_children=?, fm_msg_message=?, fm_msg_terms=?, fm_msg_success=?, about_kicker=?, about_heading=?, about_p1=?, about_p2=?, about_p3=?, enquire_heading=?, enquire_lead=?, enquire_points=?, booking_terms_text=?, policies_footer_note=?, footer_tagline=? WHERE id=?',
    [
        ...
        trim($_POST['fm_msg_checkout']), trim($_POST['fm_msg_room']), trim($_POST['fm_msg_adults']), trim($_POST['fm_msg_children']), trim($_POST['fm_msg_message']), trim($_POST['fm_msg_terms']), trim($_POST['fm_msg_success']),
