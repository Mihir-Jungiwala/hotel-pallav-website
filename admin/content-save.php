...
db_run(
    ...
    [
        ...
        trim($_POST['fm_msg_checkout']), trim($_POST['fm_msg_room']), trim($_POST['fm_msg_adults']), trim($_POST['fm_msg_children']), trim($_POST['fm_msg_message']), trim($_POST['fm_msg_terms']),
