...
<style>
  ...
  .e404-mesh{ position:absolute; inset:0; background:radial-gradient(circle at 18% 20%, var(--p100), transparent 55%), radial-gradient(circle at 85% 80%, var(--p100), transparent 50%); pointer-events:none; }
  ...
  .e404-num{ font-family:'Playfair Display',Georgia,serif; font-size:clamp(72px,16vw,150px); font-weight:700; line-height:1; letter-spacing:-.02em;
    background:linear-gradient(135deg,var(--p600),var(--p900)); -webkit-background-clip:text; background-clip:text; color:transparent; }
  .e404-door{ display:inline-block; margin:2px 0 22px; animation:doorKnock 2.4s ease-in-out infinite; }
  ...
  .e404-logo{ margin-bottom:22px; display:inline-flex; }
</style>
</head>
<body>
<section class="e404">
  <div class="e404-mesh"></div>
  <div class="e404-in rv in">
    <a href="<?= e(APP_URL) ?>/" class="e404-logo"><?php render_brand_mark(52); ?></a>
    ...
    <div class="e404-btns">
      ...
      <a href="<?= e(APP_URL) ?>/#rooms" class="btn btn-g btn-lg">Browse Real Rooms</a>
      <?php if ($gm): ?>
